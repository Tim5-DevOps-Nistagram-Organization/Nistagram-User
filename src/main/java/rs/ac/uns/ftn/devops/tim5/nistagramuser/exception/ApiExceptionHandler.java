package rs.ac.uns.ftn.devops.tim5.nistagramuser.exception;
...
import rs.ac.uns.ftn.devops.tim5.nistagramuser.dto.ErrorMessageDTO;
...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(value = {Exception.class, FollowRequestException.class})
